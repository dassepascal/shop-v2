...
if (!function_exists('price_without_vat')) {
    ...
    {
        // Attention : env() ne doit pas être utilisé dans les fichiers de config 
        // ou des fonctions appelées fréquemment. Idéalement, passez par config().
        return round($price_with_vat / (1.0 + (float)env('VAT_RATE', $vat_rate)), 2);
    }
}

// Correction ici : Fermeture du if() pour isoler les fonctions
